...
export function setCEPonds(lines = null) {
  ...
  if (lines.length > 0) {
    for (let line of lines) {
      let parts = /(RA|CE)([0-9]+)\.([A-Z]+)\s*=\s*([0-9]+(?:[.,][0-9]+){0,1})(%{0,1})/gi.exec(line);
  ...
  ponds.then((datos) => {
    ...
    html = html + `            
            <TR>
                ...
                <TH style='border: 1px solid black; background-color:#eeeeee; font-size:1em'>Porcentaje de peso del CE en todo el curso</TH>
...
<div id="dialog-form" title="Carga de CEs">
    <P> Introduce los CEs y su ponderación separados por puntos y comas, o por saltos de línea, tal y como la has puesto en gestiona FP. </P>
    <P> Por ejemplo: RA2.a=0.6%; RA2.b=1.5%; etc; o bien el porcenraje como número decimal entre 0 y 1: RA2.a=0.006; RA2.b=0.015<BR>
        </P>
    <div>
        ...
        <div class="form-group row fitem fpadextei">
                ...
                <span class="col-form-label d-inline-block ">
                    ...
                    <div class="form-control-static">
                        ...
                        <A class='btn btn-primary btn-sm' style="padding: 2px 9px;margin-left: 10px; color:white !important" id='${idBotonCalcularNotCEPond}'>Calcular</A>
